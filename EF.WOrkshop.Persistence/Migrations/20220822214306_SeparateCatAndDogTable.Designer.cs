...
namespace EF.Workshop.Persistence.Migrations
{
    ...
    [Migration("20220822214306_SeparateCatAndDogTable")]
    partial class SeparateCatAndDogTable
    {
            ...
            modelBuilder.Entity("EF.Workshop.Persistence.Models.Cat", b =>
                {
                    b.HasOne("EF.Workshop.Persistence.Models.Pet", null)
                        .WithOne()
                        .HasForeignKey("EF.Workshop.Persistence.Models.Cat", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("EF.Workshop.Persistence.Models.Dog", b =>
                {
                    b.HasOne("EF.Workshop.Persistence.Models.Pet", null)
                        .WithOne()
                        .HasForeignKey("EF.Workshop.Persistence.Models.Dog", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
